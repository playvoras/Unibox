...
MAKE_SIGNATURE(CCraftingPanel_UpdateCraftButton_IsFreeTrialAccount_Call, "client.dll", "E8 ? ? ? ? 84 C0 74 ? 41 38 7D", 0x0);
...
MAKE_HOOK(IsFreeTrialAccount, S::IsFreeTrialAccount(), bool)
{
	...
	if (dwRetAddr - 0x5 == dwDesired && Vars::Misc::Exploits::PremiumCraftingBypass.Value)
		return false;
